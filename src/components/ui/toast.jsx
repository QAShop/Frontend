// components/ui/toast.jsx (СТАНДАРТНАЯ РЕАЛИЗАЦИЯ SHADCN/UI)
...
const ToastProvider = ToastPrimitives.Provider // Это стандартный ToastProvider из Radix
...
const Toast = React.forwardRef(({ className, variant, children, ...props }, ref) => {
  return (
    ...
    >
      {children}
      <ToastPrimitives.Close className="absolute right-2 top-2 rounded-md p-1 text-slate-950/50 opacity-0 transition-opacity hover:text-slate-950 focus:opacity-100 focus:outline-none focus:ring-2 group-hover:opacity-100 group-[.destructive]:text-red-300 group-[.destructive]:hover:text-red-50 group-[.destructive]:focus:ring-red-400 group-[.destructive]:focus:ring-offset-600 dark:text-slate-50/50 dark:hover:text-slate-50">
        <X className="h-4 w-4" />
...
export {
  ToastProvider, // Стандартный провайдер
  ToastViewport,
  Toast,
  ToastTitle,
  ToastDescription,
